...
def get_proxies(co=co):
    driver = webdriver.Chrome(browser, options=co)
...
def proxy_driver(PROXIES, co=co):
    ...
    prox.http_proxy = prox.socks_proxy = prox.ssl_proxy = pxy
    # prox.socks_proxy = pxy
    # prox.ssl_proxy = pxy
    capabilities = webdriver.DesiredCapabilities.CHROME
    prox.add_to_capabilities(capabilities)
    driver = webdriver.Chrome(browser, options=co, desired_capabilities=capabilities)
